...
function install_FIREBASE_key_info() {
  ...
  echo "Installing FIREBASE key info file."
  scp $IDENTITY $KEYS_DIRECTORY/$FIREBASE_KEY_FILENAME $WORKING_AS@$INSTANCE_DNS_IPV4:/home/$SERVER_NAME/.keys
  ssh $IDENTITY $WORKING_AS@$INSTANCE_DNS_IPV4 "sudo chmod -R 660 /home/$SERVER_NAME/.keys/$FIREBASE_KEY_FILENAME;"
}
